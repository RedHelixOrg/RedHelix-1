...
//    }
    public void openConnection(final RedHxTcpProtocolTypeEnum httpProtocol,
                               ...
                               final RedHxRedfishProtocolVersionEnum redfishProtocolVersion) throws URISyntaxException
    {
        serviceRootLocator = ServiceRootReader.getServiceRootLocator(client,
                                                                     httpProtocol,
                                                                     hostName,
                                                                     tcpPortNumber,
                                                                     servicePrefix,
