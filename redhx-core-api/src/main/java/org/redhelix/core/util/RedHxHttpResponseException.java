...
/**
 * Identify a problem receiving a HTTP response
 * <br><br>
 * Git SHA: $Id$
 *
 ...
 *
 */
public class RedHxHttpResponseException extends Exception
{
    ...
    public RedHxHttpResponseException(final RedHxServiceRootIdEum serviceRootId, int httpErrorCode, String message)
    {
        super(message);
