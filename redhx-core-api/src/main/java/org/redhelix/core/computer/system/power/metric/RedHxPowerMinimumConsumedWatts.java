 ...
 *
 */
public class RedHxPowerMinimumConsumedWatts extends RedHxAbstractPowerWatts
{
     ...
     * @param wattsMinor
     */
    RedHxPowerMinimumConsumedWatts(final short wattsMajor, final byte wattsMinor)
    {
