 ...
 *
 */
public class RedHxPowerAverageConsumedWatts extends RedHxAbstractPowerWatts
{

    public RedHxPowerAverageConsumedWatts(final short wattsMajor, final byte wattsMinor)
    {
