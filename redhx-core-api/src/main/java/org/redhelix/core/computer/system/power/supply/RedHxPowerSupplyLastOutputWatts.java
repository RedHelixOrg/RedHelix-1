 ...
 *
 */
public class RedHxPowerSupplyLastOutputWatts extends RedHxAbstractPowerWatts
{

    public RedHxPowerSupplyLastOutputWatts(final short wattsMajor, final byte wattsMinor)
    {
