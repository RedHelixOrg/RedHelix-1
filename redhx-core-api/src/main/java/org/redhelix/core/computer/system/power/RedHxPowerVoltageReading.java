...
public interface RedHxPowerVoltageReading
{
    ...
    /**
     * The maximum fractional voltage. Fractional voltages are in 1/10 of a volt.
     */
     ...
     *
     * @return the voltageMajor. A value between {@link MIN_VOLTAGE_MAJOR_READING} and {@link MAX_VOLTAGE_MAJOR_READING}.
     */
     ...
     *
     * @return the voltageMinor. A value between {@link MIN_VOLTAGE_MINOR_READING} and {@link MAX_VOLTAGE_MINOR_READING}.
     */
