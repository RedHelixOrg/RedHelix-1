 ...
 *
 */
public class RedHxPowerIntervalMinimumWatts extends RedHxAbstractPowerWatts
{
     ...
     * @param wattsMinor
     */
    RedHxPowerIntervalMinimumWatts(final short wattsMajor, final byte wattsMinor)
    {
