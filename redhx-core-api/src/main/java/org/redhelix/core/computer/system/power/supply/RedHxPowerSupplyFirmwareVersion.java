 ...
 *
 */
public class RedHxPowerSupplyFirmwareVersion extends RedHxAbstractStringProperty
{
    /**
     ...
     * @param propName
     */
    public RedHxPowerSupplyFirmwareVersion(int maxCharCount, String propName)
    {
