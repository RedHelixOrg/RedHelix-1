 ...
 *
 */
public class RedHxPowerSupplyCapacityWatts extends RedHxAbstractPowerWatts
{

    public RedHxPowerSupplyCapacityWatts(final short wattsMajor, final byte wattsMinor)
    {
