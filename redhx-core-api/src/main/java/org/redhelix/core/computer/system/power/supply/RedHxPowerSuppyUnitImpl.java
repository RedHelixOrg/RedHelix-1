 ...
 *
 */
public class RedHxPowerSuppyUnitImpl implements RedHxPowerSuppyUnit
{
     ...
     */
    public RedHxPowerSuppyUnitImpl(
            RedHxPowerSupplyCapacityWatts capacityWatts,
    ...
    public int hashCode()
    {
        ...
        result = prime * result + ((lineInputVoltageType == null) ? 0 : lineInputVoltageType.hashCode());
