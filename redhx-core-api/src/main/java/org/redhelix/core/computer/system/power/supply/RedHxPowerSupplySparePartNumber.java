 ...
 *
 */
public class RedHxPowerSupplySparePartNumber extends RedHxAbstractStringProperty
{
    /**
     ...
     * @param propName
     */
    public RedHxPowerSupplySparePartNumber(int maxCharCount, String propName)
    {
