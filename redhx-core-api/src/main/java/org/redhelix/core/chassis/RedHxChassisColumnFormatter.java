...
public final class RedHxChassisColumnFormatter
{
                                 ...
                                 PrintStream streamOut)
    {
        ...
        {
            valueList.add(chassis.getAssetTag().getAssetTag());
        }
        else
        {
            valueList.add("");
        ...
        {
            valueList.add(chassis.getChassisDescription().getDescription());
        }
        else
        {
            valueList.add("");
        ...
        {
            valueList.add(chassis.getChassisId().getId());
        }
        else
        {
            valueList.add("");
        ...
        {
            valueList.add(chassis.getChassisName().getChassisName());
        }
        else
        {
            valueList.add("");
        ...
        if (isPathPrinted)
        {
            ...
            {
                valueList.add(chassis.getContainedByUriPath().getPath());
            }
            else
            {
                valueList.add("");
        ...
        if (isPathPrinted)
        {
            ...
            {
                valueList.add(chassis.getLogServicesUriPath().getPath());
            }
            else
            {
                valueList.add("");
        ...
        {
            valueList.add(chassis.getManufacturerName().getManufacturerName());
        }
        else
        {
            valueList.add("");
        ...
        {
            valueList.add(chassis.getModelNumber().getModelNumber());
        }
        else
        {
            valueList.add("");
        ...
        {
            valueList.add(chassis.getPartNumber().getPartNumber());
        }
        else
        {
            valueList.add("");
        ...
        if (isPathPrinted)
        {
            ...
            {
                valueList.add(chassis.getPowerUriPath().getPath());
            }
            else
            {
                valueList.add("");
        ...
        {
            valueList.add(chassis.getSerialNumber().getSerialNumber());
        }
        ...
        {
            valueList.add(chassis.getSku().getSkuValue());
        }
        ...
        if (isPathPrinted)
        {
            ...
            {
                valueList.add(chassis.getThermalUriPath().getPath());
            }
