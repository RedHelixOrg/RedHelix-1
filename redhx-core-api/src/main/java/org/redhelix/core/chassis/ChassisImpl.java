        ...
        implements RedHxChassis
{
    ...
    public String toString( )
    {
        ...
        if (assetTag != null)
        {
            toStringBuilder.append(", assetTag=").append(this.assetTag.getAssetTag());
        }

        if (chassisDescription != null)
        {
            toStringBuilder.append(", chassisDescription=").append(this.chassisDescription.getDescription());
        }

        if (chassisId != null)
        {
            toStringBuilder.append(", chassisId=").append(this.chassisId.getId());
        }

        if (chassisName != null)
        {
            toStringBuilder.append(", chassisName=").append(this.chassisName.getChassisName());
        }
        ...
        {
            toStringBuilder.append(", containedByUriPath=").append(this.containedByUriPath.getPath());
        }
        ...
        {
            toStringBuilder.append(", manufacturerName=").append(this.manufacturerName.getManufacturerName());
        }

        if (modelNumber != null)
        {
            toStringBuilder.append(", modelNumber=").append(this.modelNumber.getModelNumber());
        }
        ...
        if (partNumber != null)
        {
            toStringBuilder.append(", partNumber=").append(this.partNumber.getPartNumber());
        }
        ...
        {
            toStringBuilder.append(", powerUriPath=").append(this.powerUriPath.getPath());
        }

        if (serialNumber != null)
        {
            toStringBuilder.append(", serialNumber=").append(this.serialNumber.getSerialNumber());
        }

        if (sku != null)
        {
            toStringBuilder.append(", sku=").append(this.sku.getSkuValue());
        }
        ...
        {
            toStringBuilder.append(", thermalUriPath=").append(this.thermalUriPath.getPath());
        }
