...
public enum RedHxOperatingHealthRollupEnum {
  OK("OK", "Normal."), WARNING("Warning", "A condition exists that requires attention."), CRITICAL(
      "Critical", "A critical condition exists that requires immediate attention.");

  private final String desc;
  private final String jsonKeyword;

  private RedHxOperatingHealthRollupEnum(String jsonKeyword, String desc) {
  ...
  /**
   * convert from the RedFish JSON keyword into the enumeration. The JSON keyswords are found in the
   * Redfish file Resource.json.
   *
