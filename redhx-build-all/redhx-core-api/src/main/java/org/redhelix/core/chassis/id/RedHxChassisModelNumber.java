...
/**
 * The chassis model name. This is sometimes known as the model number but Redfish allows a string
 * containing non-numeric characters. Git SHA: $Id$
 *
 * @since RedHelix Version 0.1
 * @author Hank Bruning
 *
 */
public interface RedHxChassisModelNumber extends RedHxStringProperty {
