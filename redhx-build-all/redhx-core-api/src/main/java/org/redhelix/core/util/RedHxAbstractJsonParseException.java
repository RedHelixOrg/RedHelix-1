...
/**
 * Identify a where a problem occured when parsing a Redfish JSON message.
 *
 *
 *
 ...
 *
 */
public abstract class RedHxAbstractJsonParseException extends Exception {

  private final RedHxServiceRootIdEum serviceRootId;

  public RedHxAbstractJsonParseException(RedHxServiceRootIdEum serviceRootId, String message) {
    super(message);
