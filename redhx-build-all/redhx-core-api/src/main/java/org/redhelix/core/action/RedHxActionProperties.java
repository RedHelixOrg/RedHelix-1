 ...
 *
 */
public interface RedHxActionProperties extends Comparable<RedHxActionProperties> {
   ...
   *
   * @return an immutable list of action values. The list is sorted in alpha order. The list may be
   *         empty.
   */
