 ...
 *
 */
public final class RedHxChassisServiceEdmProvider
        extends RedHxAbstractEdmProvider
{
    ...
    /*
     *  Entity Set Names and is plural. Because the plural of chassis is the exact same spelling a x has been added to the plural form and
     * super's constructor is used with two arguments. This no normal and if a the Entity type name can end with a "s" the prefered
     * super construtor with single argument is perfered.
     */
    static final String ES_CHASSISX_NAME = "chassisx";

    public RedHxChassisServiceEdmProvider()
    {
        super(ET_CHASSIS_NAME,
              ES_CHASSISX_NAME);
    }
