 ...
 *
 */
public final class RedHxComputerSystemServiceEdmProvider
        extends RedHxAbstractEdmProvider
{
    ...
    public CsdlEntityType getEntityType()
    {
        ...
        CsdlProperty description = new CsdlProperty().setName("CDescription").setType(EdmPrimitiveTypeKind.String.getFullQualifiedName());
