 ...
 *
 */
public abstract class RedHxAbstractEdmProvider
        implements RedHxEdmProvider
{
    ...
    {
        this.schemaFullyQualifiedNameSpace = new FullQualifiedName(RedHxServiceEdmProvider.SCHEMA_NAME_SPACE);
        this.fqdName = new FullQualifiedName(schemaFullyQualifiedNameSpace.getFullQualifiedNameAsString(),
                                             singularName);
                                            ...
                                            String... enumValues)
    {
        ...
        FullQualifiedName fqn = new FullQualifiedName(RedHxServiceEdmProvider.SCHEMA_NAME_SPACE,
                                                      enumTypeName);
