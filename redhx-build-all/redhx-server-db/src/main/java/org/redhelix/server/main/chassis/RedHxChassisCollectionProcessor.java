 ...
 *
 */
public final class RedHxChassisCollectionProcessor implements EntityCollectionProcessor {
  ...
  private EntityCollection getData(EdmEntitySet edmEntitySet) {
    ...
    if (RedHxChassisServiceEdmProvider.ES_CHASSISX_NAME.equals(edmEntitySet.getName())) {
      ...
      entityList.add(new Entity().addProperty(new Property(null, "ID", ValueType.PRIMITIVE, 1))
          .addProperty(new Property(null, "Name", ValueType.PRIMITIVE, "Notebook Basic 15"))
          .addProperty(new Property(null, "Description", ValueType.PRIMITIVE,
              "Notebook Basic, 1.7GHz - 15 XGA - 1024MB DDR2 SDRAM - 40GB")));
      entityList.add(new Entity().addProperty(new Property(null, "ID", ValueType.PRIMITIVE, 2))
          .addProperty(new Property(null, "Name", ValueType.PRIMITIVE, "1UMTS PDA"))
          .addProperty(new Property(null, "Description", ValueType.PRIMITIVE,
              "Ultrafast 3G UMTS/HSDPA Pocket PC, supports GSM network")));
      entityList.add(new Entity().addProperty(new Property(null, "ID", ValueType.PRIMITIVE, 3))
