...
public final class RedHxDiscoveryProcessor
        implements ActionEntityProcessor//, ActionComplexProcessor
{
    ...
    public RedHxDiscoveryProcessor(final OData odata,
                                   final Edm edm)
    {
        dataProvider = new DataProvider(odata,
                                        edm);
    }
...
//  }
            ...
            throws ODataApplicationException
    {
        if (((uriResource instanceof UriResourceEntitySet)
                ...
                || ((UriResourceEntitySet) uriResource).getTypeFilterOnEntry() != null)) || ((uriResource instanceof UriResourceFunction) && (((UriResourceFunction) uriResource).getTypeFilterOnCollection() != null
                || ((UriResourceFunction) uriResource).getTypeFilterOnEntry() != null)) || ((uriResource instanceof UriResourceNavigation) && (((UriResourceNavigation) uriResource).getTypeFilterOnCollection()
                != null || ((UriResourceNavigation) uriResource).getTypeFilterOnEntry() != null)))
        {
