 ...
 * the License.
 */
package org.redhelix.server.data;// org.apache.olingo.server.tecsvc.data;
...
public class FunctionData {
  ...
  protected static EntityCollection entityCollectionFunction(final String name,
      final List<UriParameter> parameters, final Map<String, EntityCollection> data)
    ...
    if (name.equals("UFCRTCollETTwoKeyNavParam")) {
      ...
      result.getEntities().addAll(esTwoKeyNav.subList(0,
  ...
  protected static Property primitiveComplexFunction(final String name,
      final List<UriParameter> parameters, final Map<String, EntityCollection> data,
    ...
    if (name.equals("UFNRTInt16")) {
      ...
      try {
        return DataCreator.createComplex(name,
            DataCreator.createPrimitive("PropertyInt16",
                oData.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.Int16).valueOfString(
                    getParameterText("ParameterInt16", parameters), null, null, null, null, null,
                    Short.class)),
            DataCreator.createPrimitive("PropertyString",
                oData.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.String).valueOfString(
      ...
      if (parameterStringRaw == null) {
        ...
        try {
          final EdmPrimitiveType edmInt16 =
              oData.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.Int16);
          final EdmPrimitiveType edmString =
              oData.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.String);
          final Short parameterInt16 =
              edmInt16.valueOfString(parameterInt16Raw, null, null, null, null, null, Short.class);
      ...
      try {
        Short parameterInt16 =
            edmInt16.valueOfString(parameteInt16Raw, null, null, null, null, null, Short.class);
        ...
        if (parameterStringRaw == null) {
          ...
          return new Property(null, "value", ValueType.COLLECTION_COMPLEX,
              Arrays.asList(new ComplexValue[] {complexValue1, complexValue2}));
        } else {
          ...
          for (short i = parameterInt16; 0 < i; i--) {
            ...
            complexValue.getValue()
                .add(new Property(null, "PropertyInt16", ValueType.PRIMITIVE, counter++));
