...
public class RequestValidator {
  ...
  public RequestValidator(final DataProvider provider, final boolean isUpdate,
      final boolean isPatch, final String rawServiceRoot) {
  ...
  private ValidationResult validateBinding(final Link navigationBinding,
      final EdmNavigationProperty edmProperty) throws DataProviderException {
