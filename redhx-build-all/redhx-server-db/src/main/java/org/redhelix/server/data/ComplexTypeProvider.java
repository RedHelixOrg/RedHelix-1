...
public class ComplexTypeProvider
{
    ...
    public static final FullQualifiedName nameCTAllPrim = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTAllPrim");
    public static final FullQualifiedName nameCTBase = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTBase");
    public static final FullQualifiedName nameCTBasePrimCompNav = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE,
                                                                                        "CTBasePrimCompNav");
    public static final FullQualifiedName nameCTCollAllPrim = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE,
                                                                                    "CTCollAllPrim");
    public static final FullQualifiedName nameCTCompCollComp = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE,
                                                                                     "CTCompCollComp");
    public static final FullQualifiedName nameCTCompComp = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTCompComp");
    public static final FullQualifiedName nameCTCompNav = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTCompNav");

    public static final FullQualifiedName nameCTMixPrimCollComp = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE,
                                                                                        "CTMixPrimCollComp");
    public static final FullQualifiedName nameCTNavFiveProp = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE,
                                                                                    "CTNavFiveProp");
    public static final FullQualifiedName nameCTPrim = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTPrim");
    public static final FullQualifiedName nameCTPrimComp = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTPrimComp");
    public static final FullQualifiedName nameCTTwoBase = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTTwoBase");
    public static final FullQualifiedName nameCTTwoBasePrimCompNav
                                          = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTTwoBasePrimCompNav");
    public static final FullQualifiedName nameCTTwoPrim = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTTwoPrim");
    public static final FullQualifiedName nameCTMixEnumDef = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE,
                                                                                   "CTMixEnumDef");
    public static final FullQualifiedName nameCTNavCont = new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "CTNavCont");
