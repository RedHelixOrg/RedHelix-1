...
public class TypeDefinitionProvider {
  ...
  public static final FullQualifiedName nameTDString =
      new FullQualifiedName(RedHxServiceEdmProvider.RED_HELIX_SCHEMA_ORG_NAMESPACE, "TDString");
  ...
  public CsdlTypeDefinition getTypeDefinition(final FullQualifiedName typeDefinitionName) {
    if (nameTDString.equals(typeDefinitionName)) {
      return new CsdlTypeDefinition().setName(nameTDString.getName())
          .setUnderlyingType(EdmPrimitiveTypeKind.String.getFullQualifiedName()).setMaxLength(15);
    }
    return null;
  }
