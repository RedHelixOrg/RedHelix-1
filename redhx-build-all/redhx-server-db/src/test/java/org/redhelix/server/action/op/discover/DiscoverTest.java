 ...
 *
 */
public final class DiscoverTest extends RedHexlixAbstractServiceTest {

  private static final String SERVICE_NAME = RedHxDiscoverSystemEdmProvider.ET_DISCOVER_SYSTEM_NAME;

  @Test
  public void postDiscoveryTest() throws Exception {
    //
  ...
  private class DiscoverSystemResult implements ClientInvokeResult {
  }
