...
public class Constants {
  ...
  private final static Map<ConstantKey, String> v4constants =
      new EnumMap<ConstantKey, String>(ConstantKey.class);

  private final static Map<ConstantKey, String> constants =
      new EnumMap<ConstantKey, String>(ConstantKey.class);
  ...
  static {
    ...
    v4constants.put(ConstantKey.DATASERVICES_NS,
        "http://docs.oasis-open.org/odata/ns/dataservices");
    ...
    v4constants.put(ConstantKey.DEFAULT_SERVICE_URL,
    ...
    constants.put(ConstantKey.DEFAULT_SERVICE_URL,
    ...
    constants.put(ConstantKey.ATOM_LINK_REL,
    ...
    constants.put(ConstantKey.METADATA_NS,
        "http://schemas.microsoft.com/ado/2007/08/dataservices/metadta");
    constants.put(ConstantKey.DATASERVICES_NS,
