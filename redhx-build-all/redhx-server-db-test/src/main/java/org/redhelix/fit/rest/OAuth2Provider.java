...
public class OAuth2Provider implements AuthorizationCodeDataProvider {
  ...
  @Override
  public ServerAccessToken getPreauthorizedToken(final Client client, final List<String> list,
      final UserSubject us, final String string) throws OAuthServiceException {

    return null;
  }

  @Override
  public List<OAuthPermission> convertScopeToPermissions(final Client client,
  ...
  public ServerAuthorizationCodeGrant removeCodeGrant(final String code)
      throws OAuthServiceException {
    return grant == null || !grant.getCode().equals(code) ? null : grant;
  }
  ...
  @Override
  public ServerAccessToken refreshAccessToken(final Client client, final String string,
      final List<String> list) throws OAuthServiceException {
  ...
  @Override
  public void revokeToken(final Client client, final String string, final String string1)
      throws OAuthServiceException {
    throw new UnsupportedOperationException("Not supported yet.");
  }
