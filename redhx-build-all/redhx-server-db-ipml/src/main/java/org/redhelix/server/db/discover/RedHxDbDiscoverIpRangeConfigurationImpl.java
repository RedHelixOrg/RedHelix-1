...
@Table(name = "DiscoverIpRangeConfig")
public class RedHxDbDiscoverIpRangeConfigurationImpl extends AbstractDiscoverConfiguration
  ...
  public RedHxDbDiscoverIpRangeConfigurationImpl(Date createDate, String description,
      boolean isActive, InetAddress beginingInetAddress, InetAddress endingInetAddress) {
  ...
  RedHxDbDiscoverIpRangeConfigurationImpl() {}
