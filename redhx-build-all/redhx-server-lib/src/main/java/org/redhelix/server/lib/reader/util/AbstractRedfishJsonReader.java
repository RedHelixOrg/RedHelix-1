...
/**
 * execute olingo commands to read the Redfish resources and links. This class executes the HTTP
 * request to read data from the server and subclasses do not have to execute any HTTP commands.
 * They do have to parse the JSON response.
 *
 *
 *
...
public abstract class AbstractRedfishJsonReader {
  ...
  private final static String JSON_SUB_KEY_STATUS_HEALTH_ROLLUP = "HealthRollUp"; // bug in redfish.
                                                                                  // the
                                                                                  // Resource.json
                                                                                  // file says the U
                                                                                  // is lower case
   ...
   * HTTP error an exception is throw an no other methods in the class can be called. As a result
   * all methods in subclass of this do not perform error checking for the HTTP response.
   *
   * @param ctx
   * @param serviceRootId
  ...
  protected AbstractRedfishJsonReader(final RedHxServerConnectionContext ctx,
      final RedHxServiceRootIdEum serviceRootId, final RedHxUriPath pathToResource)
    ...
    if (isResponseValid) {
      ...
      throw new RedHxHttpResponseException(serviceRootId, response.getStatusCode(),
  ...
  protected Set<RedHxActionProperties> getActions(String propName) {
    ...
    if (clientProp != null) {
      /*
       * HFB5: the action is , XXXXXXXXX
       * anno=org.apache.olingo.client.core.domain.ClientComplexValueImpl@7f3b84b8[
       * navigationLinks=[] associationLinks=[] annotations=[]
       * fields={#ComputerSystem.Reset=ODataPropertyImpl{name=#ComputerSystem.Reset,valuable=org.
       * apache.olingo.client.core.domain.ClientValuableImpl@6069db50[
       * value=org.apache.olingo.client.core.domain.ClientComplexValueImpl@5c33f1a9[
       *
       * navigationLinks=[] associationLinks=[] annotations=[]
       * fields={target=ODataPropertyImpl{name=target,valuable=org.apache.olingo.client.core.domain.
       * ClientValuableImpl@49139829[ value=/redfish/v1/Systems/1/Actions/ComputerSystem.Reset ],
       * annotations=[]}} typeName=<null> ] ], annotations=[]},
       * Oem=ODataPropertyImpl{name=Oem,valuable=org.apache.olingo.client.core.domain.
       * ClientValuableImpl@2f9f7dcf[
       * value=org.apache.olingo.client.core.domain.ClientComplexValueImpl@1b7cc17c[
       * navigationLinks=[] associationLinks=[] annotations=[]
       * fields={#Contoso.Reset=ODataPropertyImpl{name=#Contoso.Reset,valuable=org.apache.olingo.
       * client.core.domain.ClientValuableImpl@5b8dfcc1[
       * value=org.apache.olingo.client.core.domain.ClientComplexValueImpl@77fbd92c[
       * navigationLinks=[] associationLinks=[] annotations=[]
       * fields={target=ODataPropertyImpl{name=target,valuable=org.apache.olingo.client.core.domain.
       * ClientValuableImpl@72967906[ value=/redfish/v1/Systems/1/OEM/Contoso/Actions/Contoso.Reset
       * ], annotations=[]}} typeName=<null> ] ], annotations=[]}} typeName=<null> ] ],
       * annotations=[]}} typeName=<null> ]
       */
      ...
      while (iter.hasNext()) {
        ...
        if (cp.getName().equals("Oem")) {
          ...
          while (iter2.hasNext()) {
            ...
            RedHxActionProperties action = new RedHxActionPropertiesImpl(actionName, actionsPath);
          ...
          /**
           * todo: this does not read the ResetType@Redfish.AllowableValues for the Reset action. I
           * can't find them using olingo beta3.
           */
          while (iter2.hasNext()) {
            ClientProperty cp2 = iter2.next();
   ...
   * @return
   */
  protected String getComplexValue(String primaryKeyName, String subKeyName) {
  ...
  protected String getLinkSingle(String propName) {
    ...
    if (clientProp != null) {
      ...
      if ((prop2 != null) && !prop2.hasCollectionValue()) {
        List<ClientAnnotation> annotationList =
            prop2.getComplexValue().asComplex().getAnnotations();
  ...
  protected RedHxOperatingStatus getOperatingStatus(String primaryKeyName) {
    String tmpStr = getComplexValue(primaryKeyName, JSON_SUB_KEY_STATUS_HEALTH);
    ...
    if ((opHealth != null) || (opRollup != null) || (opState != null)) {
      computerOperatingStatus = new RedHxOperatingStatusImpl(opHealth, opRollup, opState);
    } else {
