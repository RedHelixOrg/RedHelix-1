 ...
 *
 */
public final class RedHxPowerSupplyLineInputVoltageImpl extends RedHxAbstractPowerVoltageReading
    implements RedHxPowerSupplyLineInputVoltage {
   ...
   */
  public RedHxPowerSupplyLineInputVoltageImpl(short voltageMajor, byte voltageMinor) {
