 ...
 *
 */
public final class RedHxPowerSuppyUnitImpl
        implements RedHxPowerSuppyUnit
{
    ...
    public RedHxPowerSuppyUnitImpl( RedHxPowerSupplyCapacityWatts            capacityWatts,
                                    ...
                                    RedHxPowerSupplyModelNumber              modelNumber,
                                    RedHxPowerSupplyName                     powerSupplyName,
                                    RedHxPowerSupplyPartNumber               partNumber,
                                    RedHxPowerSupplySerialNumber             serialNumber,
                                    RedHxPowerSupplySparePartNumber          sparePartNumber,
                                    RedHxPowerSupplyTypeEnum                 powerSupplyType )
    {
        super();
    ...
    public int hashCode( )
    {
        ...
        result = prime * result + ((firmwareVersion == null)
                                   ? 0
                                   : firmwareVersion.hashCode());
        result = prime * result + ((lineInputVoltage == null)
                                   ? 0
                                   : lineInputVoltage.hashCode());
        result = prime * result + ((lineInputVoltageType == null)
                                   ? 0
                                   : lineInputVoltageType.hashCode());
        result = prime * result + ((modelNumber == null)
                                   ? 0
                                   : modelNumber.hashCode());
        result = prime * result + ((partNumber == null)
                                   ? 0
                                   : partNumber.hashCode());
        result = prime * result + ((powerSupplyName == null)
                                   ? 0
                                   : powerSupplyName.hashCode());
        result = prime * result + ((powerSupplyType == null)
                                   ? 0
                                   : powerSupplyType.hashCode());
        result = prime * result + ((serialNumber == null)
                                   ? 0
                                   : serialNumber.hashCode());
        result = prime * result + ((sparePartNumber == null)
                                   ? 0
                                   : sparePartNumber.hashCode());
    ...
    {
        return "RedHxPowerSuppyUnit [firmwareVersion=" + firmwareVersion + ", lineInputVoltage=" + lineInputVoltage
               + ", lineInputVoltageType=" + lineInputVoltageType + ", modelNumber=" + modelNumber + ", partNumber=" + partNumber
               + ", powerSupplyName=" + powerSupplyName + ", powerSupplyType=" + powerSupplyType + ", serialNumber=" + serialNumber
