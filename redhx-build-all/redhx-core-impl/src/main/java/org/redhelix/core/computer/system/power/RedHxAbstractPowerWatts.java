 ...
 *
 */
public abstract class RedHxAbstractPowerWatts implements RedHxPowerWatts {
   ...
   * @param wattsMinor
   */
  protected RedHxAbstractPowerWatts(final short wattsMajor, final byte wattsMinor) {
    super();

    if (wattsMajor < 0) {
      throw new IllegalArgumentException(
          "Invalid argument wattsMajor. It can not be less than zero. It was " + wattsMajor + ".");
    }

    if (wattsMinor < 0) {
      throw new IllegalArgumentException(
          "Invalid argument wattsMinor. It can not be less than zero. It was " + wattsMinor + ".");
    }
