 ...
 *
 */
public abstract class RedHxAbstractColumnFormatter implements RedHxColumnOutputFormatter {
   ...
   * @param isPathPrinted
   */
  public RedHxAbstractColumnFormatter(final boolean isRowTitlePrinted, final String columnDelimiter,
   ...
   */
  public RedHxAbstractColumnFormatter(final boolean isRowTitlePrinted, String columnDelimiter,
   ...
   * @param value
   */
  protected void addRow(String prompt, String value) {
    PromptValuePair row = new PromptValuePair(prompt, value);
  ...
  /**
   * print out the prompts and data. One row has a single prompt and singe data value. No section
   * title are printed
   *
   * @param streamOut
   * @param promptList
  ...
  private class PromptValuePair implements Comparable<PromptValuePair> {

    private final String prompt;
    private final String value;

    PromptValuePair(String prompt, String value) {
      this.prompt = prompt;
      this.value = value;
    }
