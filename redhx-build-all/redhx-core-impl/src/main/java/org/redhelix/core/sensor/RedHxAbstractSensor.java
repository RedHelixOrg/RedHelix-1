 ...
 *
 */
public abstract class RedHxAbstractSensor implements RedHxGenericSensor {

  private final RedHxSensorNameImpl sensorName;
  private final RedHxSensorNumberImpl sensorNumber;
  ...
  @Override
  public RedHxSensorNameImpl getSensorName() {
    return sensorName;
  }

  @Override
  public RedHxSensorNumberImpl getSensorNumber() {
    return sensorNumber;
  }
  ...
  public int hashCode() {
    ...
    result = prime * result + ((sensorNumber == null) ? 0 : sensorNumber.hashCode());
