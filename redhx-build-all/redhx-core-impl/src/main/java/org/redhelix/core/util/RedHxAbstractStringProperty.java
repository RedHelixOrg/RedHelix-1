...
public abstract class RedHxAbstractStringProperty
        implements RedHxStringProperty,
                   Comparable<RedHxStringProperty>
{
            ...
            String                             propName )
    {
        ...
        {
            throw new IllegalArgumentException("The maximum chararcter count can not be greater than " + Short.MAX_VALUE
                                               + ". It has to fit in short type.");
        }
