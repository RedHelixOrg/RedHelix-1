 ...
 *
 */
public final class RedHxServiceRootLocatorImpl implements RedHxServiceRootLocator {
  ...
  public RedHxServiceRootLocatorImpl(final RedHxServiceRootId serviceRoot,
      final String httpProtocolStr, final String hostName, final int tcpPortNumber,
  ...
  private RedHxServiceRootLocatorImpl() {
  ...
  public boolean equals(Object obj) {
    ...
    final RedHxServiceRootLocatorImpl other = (RedHxServiceRootLocatorImpl) obj;
  ...
  @Override
  public URI getUri(String urlString) throws URISyntaxException {
    final URI uri = new URI(tcpProtocol, null, hostName, tcpPortNumber, urlString, null, null);
