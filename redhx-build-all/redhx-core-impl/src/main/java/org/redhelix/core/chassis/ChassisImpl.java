...
/**
 * a immutable form of the chassis.
 *
 * @since RedHelix Version 0.1
 * @author Hank Bruning
 */
@Immutable
final class ChassisImpl implements RedHxChassis {

  private final RedHxActionGroup actionGroup;
  private final RedHxChassisAssetTag assetTag;
  private final RedHxChassisDescription chassisDescription;
  private final RedHxChassisId chassisId;
  private final RedHxChassisName chassisName;
  private final RedHxChassisTypeEnum chassisType;
  private final List<RedHxUriPath> computerSystemUriPathList;
  private final RedHxUriPath containedByUriPath;
  private final List<RedHxUriPath> containsList;
  ...
  private final RedHxChassisModelNumber modelNumber;
  ...
  private final RedHxUriPath powerUriPath;
  ...
  private final RedHxUriPath thermalUriPath;
   ...
   */
  ChassisImpl(RedHxActionGroup actionGroup, RedHxChassisAssetTag assetTag,
      RedHxChassisDescription chassisDescription, RedHxChassisId chassisId,
      RedHxChassisName chassisName, RedHxChassisTypeEnum chassisType,
      List<RedHxUriPath> computerSystemUriPathList, RedHxUriPath containedByUriPath,
      List<RedHxUriPath> containsList, List<RedHxUriPath> cooledByUriPathList,
      RedHxIndicatorLedStateEnum ledState, RedHxUriPath logServicesUriPath,
      RedHxChassisManufacturerName manufacturerName, RedHxChassisModelNumber modelNumber,
      RedHxOperatingHealthEnum operatingHealth, RedHxOperatingStateEnum operatingState,
      RedHxChassisPartNumber partNumber, List<RedHxUriPath> poweredByList,
      RedHxUriPath powerUriPath, RedHxChassisSerialNumber serialNumber, RedHxChassisSKU sku,
      List<RedHxUriPath> systemManagerUriPathList, RedHxUriPath thermalUriPath) {
  ...
  public String toString() {
    ...
    if ((computerSystemUriPathList != null) && !computerSystemUriPathList.isEmpty()) {
      ...
      createPathString(toStringBuilder, computerSystemUriPathList);
    }
    ...
    if ((containsList != null) && !containsList.isEmpty()) {
      ...
      createPathString(toStringBuilder, containsList);
    }

    if ((cooledByUriPathList != null) && !cooledByUriPathList.isEmpty()) {
      toStringBuilder.append(", cooledByUriPathList=");
      createPathString(toStringBuilder, cooledByUriPathList);
    }
    ...
    if ((systemManagerUriPathList != null) && !systemManagerUriPathList.isEmpty()) {
      ...
      createPathString(toStringBuilder, systemManagerUriPathList);
    }
  ...
  private static void createPathString(StringBuilder toStringBuilder, List<RedHxUriPath> pathList) {
    toStringBuilder.append("[");
