 ...
 *
 */
public final class RedHxActionGroupImpl implements RedHxActionGroup {

  private final Set<RedHxActionProperties> actionSet;

  public RedHxActionGroupImpl(final Set<RedHxActionProperties> actionSet) {
    this.actionSet = Collections.unmodifiableSet(actionSet);
  }

  private RedHxActionGroupImpl() {
    this.actionSet = null;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final RedHxActionGroupImpl other = (RedHxActionGroupImpl) obj;
