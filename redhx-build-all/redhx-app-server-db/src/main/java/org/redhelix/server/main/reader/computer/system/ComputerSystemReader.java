 ...
 * the License
 */
package org.redhelix.server.main.reader.computer.system;
        ...
        extends AbstractRedfishJsonReader
{
    ...
    private final static String JSON_KEY_UEFI_TARGET_BOOT_SOURCE_OVERRIDE = "UefiTargetBootSourceOverride";
    ...
    ComputerSystemReader(RedHxServerConnectionContext ctx,
    ...
    /**
     * parse the JSON response into a RedHxComputerSystem class. It create method sent the HTTP request for the chassis message an validated
     * that a JSON message had been received.
     *
     * @param ctx
     * @param chassisLink
     * @return
                   ...
                   URISyntaxException
    {
        ...
        /*
         * the sequence of reading the JSON file is organized in Alpha order by key name. The list of static fields(above) is in alpha order.
         */
        if (actionSet != null)
        {
        ...
        if (tmpStr != null)
        {
            //todo  throw new UnsupportedOperationException("Processors collection is not yet implementd");
        }
        ...
        if (tmpStr != null)
        {
            //todo  throw new UnsupportedOperationException("Simple storage collection is not yet implementd");
        }
